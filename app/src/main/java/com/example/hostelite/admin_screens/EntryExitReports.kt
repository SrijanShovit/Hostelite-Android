...
@Composable
fun EntryExitRecords(navController: NavController){
    val headers = listOf(
        "Date",
        "Roll No.",
        "Room No. ",
    ...
    val data = listOf(
        listOf(
            "16-02-2022", "2106037", "2-03" ,"4:30 PM", "Market", "23456", "6:30 PM"
        ),
        listOf(
            "16-02-2022", "2106037", "2-03" ,"4:30 PM", "Market", "23456", "6:30 PM"
        ),
    ...
    Scaffold(
        topBar = { AppBar(navController = navController, text = "Entry-Exit Reports")},
